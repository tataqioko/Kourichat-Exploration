        ...
        try:
            ...
            with open(self.config_path, 'r', encoding='utf-8') as f:
                ...
                self.llm = LLMSettings(
                    ...
                    top_p=float(llm_data.get('top_p', {}).get('value', 0.95)),
                    frequency_penalty=float(llm_data.get('frequency_penalty', {}).get('value', 0.2))
                )
                ...
                self.media = MediaSettings(
                    image_recognition=ImageRecognitionSettings(
                        ...
                        top_p=float(image_recognition_data.get('top_p', {}).get('value', 0.95)),
                        frequency_penalty=float(image_recognition_data.get('frequency_penalty', {}).get('value', 0.2))
                    ),
                    image_generation=ImageGenerationSettings(
